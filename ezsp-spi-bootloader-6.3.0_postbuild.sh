...
if [ -z "${PATH_SCMD}" ]; then
  COMMANDER="D:\SiliconLabs\SimplicityStudio\v4\developer\adapter_packs\commander\commander.exe"
...
echo " "
"${COMMANDER}" convert "D:\SiliconLabs\SimplicityStudio\v4\developer\sdks\gecko_sdk_suite\v2.3/platform/bootloader/build/first_stage/gcc/first_stage_btl_efx32xg11.s37" "${FILENAME}.s37" -o "${FILENAME}-combined.s37"
